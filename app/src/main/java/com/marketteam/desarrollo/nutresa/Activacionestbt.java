...
public class Activacionestbt extends AppCompatActivity {
    ...
    static Activacionestbt activityA;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_activacionestbt);
        activityA = this;
    }
    ...
    protected void onStart() {
        ...
        //fg.ultimaPantalla("Activacionestbt");
        ...
        if (Integer.parseInt(valcn)>0) {
            ...
            pregunt = (TextView) findViewById(R.id.tvPreguntaT);
            ...
            valcampo = (EditText) findViewById(R.id.tbValTX);
    ...
    public void Volver(View v) {
        ...
        String rtax="";
        EditText rtatxt= (EditText) findViewById(R.id.tbValTX);
        rtax = rtatxt.getText().toString();
        if ((rtax.length()>7) && ((fotoa.equals("1") && fg.getFototom(Orden).equals("1")) || fotoa.equals("0"))) {
    ...
    public static Activacionestbt getInstance() {
        return activityA;
    }
}
