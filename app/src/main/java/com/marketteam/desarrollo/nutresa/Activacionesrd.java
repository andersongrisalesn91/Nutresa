...
public class Activacionesrd extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        //fg.ultimaPantalla("Activacionesrd");
        ...
        String queryActivacionesid = "SELECT idpreg,preg,cnd2,fap FROM '302_PREGGEN' where orden=" + Orden + " and gr=" + Grupo;
        ...
        if (Integer.parseInt(valcn) > 0) {
            ...
            //Sacar las fotos del producto que aplique
