...
public class FuncionesGenerales extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    /**
     * @param n n es la cantidad de parámetros a buscar
     * @return
     */
    ...
    public String getSCan() {
        ArrayList<String>[] subcanalActual = conGen.queryGeneral(contexto, "'ACT'", new String[]{"VAL"}, "VA='SUBC'");
        String SCan = subcanalActual[0].get(0);
        return SCan;
    }
...
//                return true;
            ...
            case R.id.menu4:
                ...
                Intent gen = new Intent(contexto, Generales.class);
                gen.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                contexto.startActivity(gen);
                return true;
            case R.id.menu7:
                RevisionErr();
                return true;
    ...
    public void AplazarAud() {
        //Aplazar la encuesta
        final Finalizar f = new Finalizar(contexto);
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                f.finAuditoria(3, new double[]{0, 0});
                popupWindow.dismiss();
            }
        });
    ...
    public void RechazarAud() {
        ...
        //Vista con lugar para explicar por qué se rechaza
        Intent rech = new Intent(contexto, Rechazar.class);
        rech.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        contexto.startActivity(rech);
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    String sourceDBName = "nutresa.db";
                    String targetDBName = "nutresa_" + getCodProy() + ".db";
    ...
    public void BorrarBaseBackup() {
        ...
        try {
            File file = new File(fullPath, "nutresa_" + getCodProy() + ".db");
            if (file.exists()) {
