...
public class PopUps extends AppCompatActivity {
    ...
    public void popUpConf(final Context contexto, LayoutInflater inflater, int caso, int pantalla) {
        operaciones = new OperacionesBDInterna(contexto);
        fg = new FuncionesGenerales(contexto);
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (c == 1) {
                    ...
                    Intent volver = null;
                    if (p == 1) {
                        //Espacios vuelve a Menú
                        volver = new Intent(contexto, MenuOpciones.class);
                    } else if (p == 2) {
                        //Categorías vuelve a Espacios
                        volver = new Intent(contexto, Espacios.class);
                    } else if (p == 3) {
                        //Estándares y SKUs vuelven a Categorías
                        volver = new Intent(contexto, Categorias.class);
                    }
                    volver.addFlags(FLAG_ACTIVITY_NEW_TASK);
                    contexto.startActivity(volver);
                } else if (c == 7) {
                    Finalizar f = new Finalizar(contexto);
                    f.finCerrar();
                    FuncionesGenerales fg = new FuncionesGenerales(contexto);
    ...
    public void popUpCliente(final Context contexto, LayoutInflater inflater, String[] datos) {
        ...
        final OperacionesBDInterna operaciones = new OperacionesBDInterna(contexto);
        final ConsultaGeneral cGeneral = new ConsultaGeneral();
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intX = new Intent(contexto, DetalleCliente.class);
                intX.addFlags(FLAG_ACTIVITY_NEW_TASK);
                contexto.startActivity(intX);
                popupWindow.dismiss();
            }
        });
        cancel.setOnClickListener(new View.OnClickListener() {
