...
public class TomarFoto extends AppCompatActivity {
    ...
    public void tomarFoto(View v) throws Exception {
        Thread two = new Thread() {
            @Override
            public void run() {
                File carpetaIMG = new File(Environment.getExternalStorageDirectory() + "/DCIM/nutresa/", "img");
                if ((raiz.equals("1")) || (raiz.equals("2")) || (raiz.equals("3")) || (raiz.equals("12"))) {
                    ...
                    }else if (raiz.equals("12")) {
                        nombreFoto = fg.getAuditoria() + "_" + fg.fechaActual(2) + "_" + espAct + "_" + catAct + "_" + estndAct + "_sku.jpg";
                    }
                    path = Environment.getExternalStorageDirectory() + "/DCIM/nutresa/img/" + nombreFoto;
    ...
    public void terminar(View v) {
        ...
        if (fototomada.equals("1")) {
            ...
            if (raiz.equals("1")) {
                ...
                intx = new Intent(this, Categorias.class);
                ...
                if (sku != null) {
                    ...
                    intx = new Intent(this, SKUs.class);
                } else {
                    operaciones.queryNoData("UPDATE ACT SET VAL='1' WHERE VA='FL'");
                    intx = new Intent(this, Categorias.class);
                }
                //Si no, ir a categorías
            } else if (raiz.equals("4") || raiz.equals("5")) {
                intx = new Intent(this, Generales.class);
            }
            if (raiz.equals("7")) {
                intx = new Intent(this, Premios1.class);
            }
            if (raiz.equals("8")) {
                intx = new Intent(this, Premios2.class);
            }
            if (raiz.equals("9")) {
                intx = new Intent(this, Activos.class);
            }
            if (raiz.equals("10")) {
                intx = new Intent(this, SKUCalidad.class);
            }
            if (raiz.equals("11")) {
                ...
                if (Integer.parseInt(Tipo) == 1) {
                    intx = new Intent(this, Activaciones.class);
                } else if (Integer.parseInt(Tipo) == 2) {
                    intx = new Intent(this, Activacionesrd.class);
                } else if (Integer.parseInt(Tipo) == 3) {
                    intx = new Intent(this, Activacionestb.class);
                } else if (Integer.parseInt(Tipo) == 4) {
                    intx = new Intent(this, Activacionestbt.class);
                } else if (Integer.parseInt(Tipo) == 5) {
                    intx = new Intent(this, Activacionesrdsn.class);
                }
            }
            if (raiz.equals("12")) {
                intx = new Intent(this, SKUs.class);
